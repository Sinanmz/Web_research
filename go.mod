...
require (
	...
	github.com/gobuffalo/mw-contenttype v1.0.2 // indirect
	github.com/gobuffalo/mw-forcessl v1.0.2 // indirect
	github.com/gobuffalo/mw-paramlogger v1.0.2 // indirect
